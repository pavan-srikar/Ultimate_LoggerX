...
# Variable to track the last timestamp
...
# Function to log clipboard content every 15 minutes with timestamp
def log_clipboard():
    global last_timestamp
...
# Periodically log clipboard content (every 5 seconds)
import time
while True:
    log_clipboard()
